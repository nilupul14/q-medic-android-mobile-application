package com.example.paul14.qmedic.GoogleMap;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeoDataClient = Places.getGeoDataClient(this, new PlacesOptions.Builder().build());


        // Construct a PlaceDetectionClient.
        mPlaceDetectionClient = Places.getPlaceDetectionClient(this, new PlacesOptions.Builder().build());
...
//                                    new LatLng(mLastKnownLocation.getLongitude(),
